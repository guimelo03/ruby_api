...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rails>.freeze, [">= 4.2.0", "< 8.1"])
    ...
    s.add_development_dependency(%q<mongoid-locker>.freeze, ["~> 2.0"])
  else
    s.add_dependency(%q<rails>.freeze, [">= 4.2.0", "< 8.1"])
    ...
    s.add_dependency(%q<mongoid-locker>.freeze, ["~> 2.0"])
  end
end
